...
typedef Eigen::Matrix<Scalar, Eigen::Dynamic, Eigen::Dynamic, Eigen::DontAlign> MatrixXX;
typedef Eigen::Matrix<Scalar, 3, Eigen::Dynamic, Eigen::DontAlign> Matrix3X;
typedef Eigen::Matrix<Scalar, 2, Eigen::Dynamic, Eigen::DontAlign> Matrix2X;
typedef Eigen::Matrix<Scalar, -1, 3, Eigen::Dynamic, Eigen::DontAlign> MatrixX3;
typedef Eigen::Matrix<Scalar, -1, 2, Eigen::Dynamic, Eigen::DontAlign> MatrixX2;
typedef Eigen::Matrix<Scalar, 2, 2, Eigen::DontAlign> Matrix22;
