...
static std::map<unsigned int, std::string> POSE_BODY_25_BODY_PARTS{
    ...
    {25, "LWrist2"},
    {H135 + 0, "LThumb1CMC"},
    {H135 + 1, "LThumb2Knuckles"},
    {H135 + 2, "LThumb3IP"},
    {H135 + 3, "LThumb4FingerTip"},
    {H135 + 4, "LIndex1Knuckles"},
    {H135 + 5, "LIndex2PIP"},
    {H135 + 6, "LIndex3DIP"},
    {H135 + 7, "LIndex4FingerTip"},
    {H135 + 8, "LMiddle1Knuckles"},
    {H135 + 9, "LMiddle2PIP"},
    {H135 + 10, "LMiddle3DIP"},
    {H135 + 11, "LMiddle4FingerTip"},
    {H135 + 12, "LRing1Knuckles"},
    {H135 + 13, "LRing2PIP"},
    {H135 + 14, "LRing3DIP"},
    {H135 + 15, "LRing4FingerTip"},
    {H135 + 16, "LPinky1Knuckles"},
    {H135 + 17, "LPinky2PIP"},
    {H135 + 18, "LPinky3DIP"},
    {H135 + 19, "LPinky4FingerTip"},

    // Right Hand
    {46, "RWrist2"},
    {R135 + 20, "RThumb1CMC"},
    {R135 + 21, "RThumb2Knuckles"},
    {R135 + 22, "RThumb3IP"},
    {R135 + 23, "RThumb4FingerTip"},
    {R135 + 24, "RIndex1Knuckles"},
    {R135 + 25, "RIndex2PIP"},
    {R135 + 26, "RIndex3DIP"},
    {R135 + 27, "RIndex4FingerTip"},
    {R135 + 28, "RMiddle1Knuckles"},
    {R135 + 29, "RMiddle2PIP"},
    {R135 + 30, "RMiddle3DIP"},
    {R135 + 31, "RMiddle4FingerTip"},
    {R135 + 32, "RRing1Knuckles"},
    {R135 + 33, "RRing2PIP"},
    {R135 + 34, "RRing3DIP"},
    {R135 + 35, "RRing4FingerTip"},
    {R135 + 36, "RPinky1Knuckles"},
    {R135 + 37, "RPinky2PIP"},
    {R135 + 38, "RPinky3DIP"},
    {R135 + 39, "RPinky4FingerTip"},
    ...
    {F135 + 3, "FaceContour3"},
    {F135 + 4, "FaceContour4"},
    {F135 + 5, "FaceContour5"}, // Contour 1/3
    {F135 + 6, "FaceContour6"},
    {F135 + 7, "FaceContour7"},
    {F135 + 8, "FaceContour8"},
    {F135 + 9, "FaceContour9"},
    {F135 + 10, "FaceContour10"},
    {F135 + 11, "FaceContour11"}, // Contour 2/3
    {F135 + 12, "FaceContour12"},
    {F135 + 13, "FaceContour13"},
    {F135 + 14, "FaceContour14"},
    {F135 + 15, "FaceContour15"},
    {F135 + 16, "FaceContour16"}, // Contour 3/3
    {F135 + 17, "REyeBrow0"},
    {F135 + 18, "REyeBrow1"},
    {F135 + 19, "REyeBrow2"},
    {F135 + 20, "REyeBrow3"},
    {F135 + 21, "REyeBrow4"}, // Right eyebrow
    {F135 + 22, "LEyeBrow4"},
    {F135 + 23, "LEyeBrow3"},
    {F135 + 24, "LEyeBrow2"},
    {F135 + 25, "LEyeBrow1"},
    {F135 + 26, "LEyeBrow0"}, // Left eyebrow
    {F135 + 27, "NoseUpper0"},
    {F135 + 28, "NoseUpper1"},
    {F135 + 29, "NoseUpper2"},
    {F135 + 30, "NoseUpper3"}, // Upper nose
    {F135 + 31, "NoseLower0"},
    {F135 + 32, "NoseLower1"},
    {F135 + 33, "NoseLower2"},
    {F135 + 34, "NoseLower3"},
    {F135 + 35, "NoseLower4"}, // Lower nose
    {F135 + 36, "REye0"},
    {F135 + 37, "REye1"},
    {F135 + 38, "REye2"},
    {F135 + 39, "REye3"},
    {F135 + 40, "REye4"},
    {F135 + 41, "REye5"}, // Right eye
    {F135 + 42, "LEye0"},
    {F135 + 43, "LEye1"},
    {F135 + 44, "LEye2"},
    {F135 + 45, "LEye3"},
    {F135 + 46, "LEye4"},
    {F135 + 47, "LEye5"}, // Left eye
    {F135 + 48, "OMouth0"},
    {F135 + 49, "OMouth1"},
    {F135 + 50, "OMouth2"},
    {F135 + 51, "OMouth3"},
    {F135 + 52, "OMouth4"},
    {F135 + 53, "OMouth5"}, // Outer mouth 1/2
    {F135 + 54, "OMouth6"},
    {F135 + 55, "OMouth7"},
    {F135 + 56, "OMouth8"},
    {F135 + 57, "OMouth9"},
    {F135 + 58, "OMouth10"},
    {F135 + 59, "OMouth11"}, // Outer mouth 2/2
    {F135 + 60, "IMouth0"},
    {F135 + 61, "IMouth1"},
    {F135 + 62, "IMouth2"},
    {F135 + 63, "IMouth3"},
    ...
    {F135 + 65, "IMouth5"},
    {F135 + 66, "IMouth6"},
    {F135 + 67, "IMouth7"}, // Inner mouth
    {F135 + 68, "RPupil"},
    {F135 + 69, "LPupil"} // Pupils
};
...
static const std::vector<std::string> part_names_ar = {"m_chest",
                                                       "m_neck",
                                                       "m_head",
                                                       "m_rupperarm",
                                                       "m_rlowerarm",
...
static std::map<size_t, std::string> surface_to_openpose{
    /*
        ...
        {1041,"LPinky4FingerTip"},
            ...
            {522, "REyeBrow0"},  {521, "REyeBrow1"},  {506, "REyeBrow2"},  {505,
       "REyeBrow3"}, {66, "LEyeBrow3"},  {67, "LEyeBrow2"},  {82, "LEyeBrow1"},
       {83, "LEyeBrow0"},


            {7, "NoseUpper0"}, {4, "NoseUpper1"}, {3, "NoseUpper2"},
            {29, "NoseLower4"}, {30, "NoseLower2"}, {2, "NoseLower2"}, {469,
       "NoseLower1"}, {468, "NoseLower0"},


            {568, "OMouth0"}, {566, "OMouth2"}, {134, "OMouth3"}, {127,
       "OMouth4"}, {129, "OMouth6"}, {132, "OMouth8"}, {133, "OMouth9"},{571,
       "OMouth10"}
...
void Pose2d::init(bool base25) {
...

  {
    for (auto forwardIT = openpose_to_skel.begin();
         forwardIT != openpose_to_skel.end(); forwardIT++) {
      skel_to_openpose[forwardIT->second] = forwardIT->first;
    }
  }

  {
    for (auto forwardIT = POSE.begin(); forwardIT != POSE.end(); forwardIT++) {
...
std::vector<size_t> Pose2d::getSurfaceIndices() {
  ...
  std::transform(surface_to_openpose.begin(), surface_to_openpose.end(),
                 std::back_inserter(keys),
                 [](const std::map<size_t, std::string>::value_type &pair) {
                   return pair.first;
                 });
  return keys;
}
