...
public:
  ...
  std::vector<std::string> GetStringVector(const std::string &section,
                                           const std::string &name);
  std::vector<bool> GetBoolVector(const std::string &section,
                                  const std::string &name);
  std::vector<float> GetFloatVector(const std::string &section,
                                    const std::string &name);
