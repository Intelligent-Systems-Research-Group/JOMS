...
private:
	...
	RTCScene scene;
	ssize_t bytes;
	unsigned int addModel (RTCScene scene_i, const Matrix3X& V, const MeshTopology& top);
	unsigned int addSubdivModel (RTCScene scene_i, const Matrix3X& V, const MeshTopology& top);
